## The below code reads data from household_power_consumption.txt file and creates a plot3.png file
...
## This data is filtered on Date field and then sent to png graphic device for plotting
  ...
  # At First a plot is created without any points, then lines are used to annotate it.Legend is also added to the end.
